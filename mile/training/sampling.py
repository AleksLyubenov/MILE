...
from mile.config.sampler import Sampler, SamplerConfig
from mile.training.callbacks import (
    progress_bar_scan,
    save_position,
)
from mile.training.warmup import custom_mclmc_warmup, custom_window_adaptation
from mile.types import (
    Kernel,
    ParamTree,
    PosteriorFunction,
    State,
...
def inference_loop(
    ...
    ----------
    unnorm_log_posterior : PosteriorFunction
        Unnormalized log posterior function check the `mile.types` module.
    config : SamplerConfig

...
from mile.config.base import BaseConfig
from mile.config.data import DataConfig
from mile.config.models.base import ModelConfig
from mile.config.training import TrainingConfig
from mile.exceptions import MissingConfigError, ModelNotFoundError

models_module = importlib.import_module('mile.models')
    ...
    def to_template(cls, model: str | nn.Module):
        ...
        ----------
            model: str | nn.Module
                ...
                in the `__init__.py` file of `mile.models` submodule,
        ...
        Example:
            ...
            from mile.config.models.base import ModelConfig, Activation
